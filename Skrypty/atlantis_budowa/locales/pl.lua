Locales['pl'] = {
  ...
  ['wear_work'] = 'strój pracownika budowy',
  ...
  ['only_scrap'] = 'możesz przechowywać tylko autoryzowane auta.',
  ...
  ['must_in_scrap'] = 'musisz być w taksówce aby rozpocząć misję',
