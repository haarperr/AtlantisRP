...
RegisterNetEvent('esx_ambulancejob:removedeathstatus')
AddEventHandler('esx_ambulancejob:removedeathstatus', function()
...
AddEventHandler('playerSpawned', function()
	...
	if FirstSpawn then
		...
		ESX.TriggerServerCallback('esx_ambulancejob:getDeathStatus', function(isDead)
			...
			-- Podejscie do save smierci by funky najebany
			--if isDead then=
			--	SetEntityHealth(GetPlayerPed(-1), -100)
			--	print(('esx_ambulancejob: %s save smierci'):format(xPlayer.identifier))
			--end
		end)
	end
end)
...
function OnPlayerDeath()
	if not IsDead then
		...
		Citizen.Wait(Config.DistressCallWait)
		StartDistressSignal()
	end
end
...
AddEventHandler('esx_ambulancejob:useItem', function(itemName)
	...
	DisableControlAction(0, 82, true) -- .
			...
			TriggerEvent('esx_ambulancejob:heal', 'small', false)
			...
			if IsControlPressed(0, Keys['G']) then
				ESX.TriggerServerCallback('gcPhone:checkPhoneCount', function(data)
					if data > 0 then
						...
						ESX.ShowNotification('Nie masz przy sobie telefonu z którego mógłbyś wezwać pomoc.')
					end
...
function SendDistressSignal()
	...
	local DistressNumber1 = math.random(1,99)

	ESX.ShowNotification(_U('distress_sent'))
	    TriggerServerEvent('esx_addons_gcphone:startCall', 'ambulance', DistressNumber1..' Potrzebna interwencja medyczna: nieprzytomny obywatel!', {
      x = coords.x,
      y = coords.y,
      z = coords.z
    })
...
function RespawnPed(ped, coords, heading)
	-- print("coordy respawn function ------------------", coords.x, coords.y, coords.z)
...
AddEventHandler('esx_ambulancejob:revive', function()
	...
	--print("revive dla: "..playerPed .. " na coords: ".. ESX.Math.Round(coords.x, 1) .. "(" .. formattedCoords.x ..")  " .. ESX.Math.Round(coords.y, 1) .. "(" .. formattedCoords.y ..")  ")
	TriggerServerEvent('esx_ambulancejob:setDeathStatus', false)
