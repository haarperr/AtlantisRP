Locales['pl'] = {
  ...
  ['only_boiler'] = 'możesz przechowywać tylko autoryzowane auta.',
  ...
  ['must_in_boiler'] = 'musisz być w taksówce aby rozpocząć misję',
