...
AddEventHandler('esx_barbie_lyftupp:lyfteruppn', function(source)
	TriggerClientEvent('esx:showNotification', source, ('Ktoś probuje cie podnieść...'))
end)

RegisterServerEvent('esx_barbie_lyftupp:setfree')
AddEventHandler('esx_barbie_lyftupp:setfree', function(target)
local _source = source
local _target = target
	TriggerClientEvent('esx_barbie_lyftupp:free', _source)
	TriggerClientEvent('esx_barbie_lyftupp:free', _target)
end)
