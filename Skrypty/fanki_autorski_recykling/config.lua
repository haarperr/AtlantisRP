...
Config.Zones = {
	...
	VehicleSpawner = {
		Pos   = {x = -332.54, y = -1516.41, z = 27.54},
	...
	VehicleSpawnPoint = {
		Pos     = {x = -329.51, y = -1523.98, z = 26.60},
	...
	VehicleDeleter = {
		Pos   = {x = -344.29, y = -1520.25, z = 26.90},
	...
	Cloakroom = {
		Pos     = {x = -355.12, y = -1514.04, z = 27.72},
		Size    = {x = 1.0, y = 1.0, z = 1.0},
		Color   = {r = 1, g = 204, b = 0},
		Type    = 21, Rotate = true
	},
	...
	Job1 = {
		Pos   = {x = -426.91, y = -1690.86, z = 18.23},
	...
	--Job2 = {
	--	Pos   = {x = 2384.54, y = 3088.03, z = 47.35},
	...
	--
	--Job3 = {
	--	Pos   = {x = 2384.54, y = 3084.03, z = 47.35},
	--	Size  = {x = 3.0, y = 3.0, z = 3.0},
	--	Color = {r=211, g=211, b=211},
	--	Type  = 27, Rotate = true
	--}
