Locales['pl'] = {
  ...
  ['wear_work'] = 'strój pracownika garbage',
  ...
  ['only_garbage'] = 'możesz przechowywać tylko autoryzowane auta.',
  ...
  ['must_in_garbage'] = 'musisz być w taksówce aby rozpocząć misję',
  ...
  ['inventory'] = 'ekwipunek',
  ['garbage_client'] = 'klient taksówki',
  ...
  ['blip_garbage'] = 'garbage',
  ['phone_garbage'] = 'garbage',
