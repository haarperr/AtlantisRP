...
Config.WheatSellEarnings		  = 10
Config.MilkSellEarnings		      = 5
...
Config.Zones = {
	...
	VehicleSpawner = {
		Pos   = {x = 1912.772, y = 4933.752, z = 48.52},
	...
	VehicleSpawnPoint = {
		Pos     = {x = 1899.228, y = 4907.512, z = 48.00},
		Size  = {x = 1.4, y = 1.4, z = 2.0},
		Type    = -1, Rotate = false,
		Heading = 170.10
	},
	...
	TrailerSpawnPoint = {
		Pos     = {x = 1905.596, y = 4908.578, z = 48.00},
		Size  = {x = 1.4, y = 1.4, z = 2.0},
		Type    = -1, Rotate = false,
		Heading = 50.61
	},
	...
	VehicleDeleter = {
		Pos   = {x = 1901.015, y = 4918.433, z = 48.00},
	...
	FarmerActions = {
		Pos   = {x = -616.91, y = -1623.08, z = 33.01},
	...
	Cloakroom = {
		Pos     = {x = 2016.53, y = 4987.391, z = 42.00},
		Size    = {x = 1.0, y = 1.0, z = 1.0},
		Color   = {r = 1, g = 204, b = 0},
		Type    = 21, Rotate = true
	},
	...
	Job1 = {
		Pos   = {x = 1905.45, y = 4807.319, z = 44.37},
		Size  = {x = 60.0, y = .0, z = 5.0},
		Color = {r=211, g=211, b=211},
		Type  = 27, Rotate = false
	},
	
	--Job1ziemniaki = {
	--	Pos   = {x = 2044.216, y = 4946.581, z = 41.06},
	--	Size  = {x = 15.0, y = .0, z = 5.0},
	--	Color = {r=211, g=211, b=211},
	--	Type  = 27, Rotate = false
	--},
	...
	--Job2 = {
	--	Pos   = {x = 427.15, y = 6465.18, z = 27.80},
	--	Size  = {x = 1.0, y = 1.0, z = 1.0},
