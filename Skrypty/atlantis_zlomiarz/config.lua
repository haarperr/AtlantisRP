...
Config.Dniowka = 585
Config.CzasZbierania = 10 -- w sekundach
Config.CzasPrzerobki = 10 -- w sekundach
Config.CzasRozladunku = 10 -- w sekundach
Config.Kara = 25 -- nagroda za oddanie sprawnego auta.
--Config.Kara = 50 -- kara za oddanie zepsutego pojazdu.
...
Config.Zones = {
	...
	VehicleSpawner = {
		Pos   = {x = 2360.22, y = 3128.53, z = 48.00},
	...
	VehicleSpawnPoint = {
		Pos     = {x = 2371.53, y = 3119.78, z = 48.16},
		Size  = {x = 1.4, y = 1.4, z = 2.0},
		Type    = -1, Rotate = false,
		Heading = 140.92
	},
	...
	VehicleDeleter = {
		Pos   = {x = 2367.59, y = 3137.92, z = 47.41},
	...
	ScrapActions = {
		Pos   = {x = 2339.24, y = 3124.97, z = 47.25},
		Size  = {x = 1.4, y = 1.4, z = 2.0},
	...
	Cloakroom = {
		Pos     = {x = 2348.45, y = 3121.77, z = 48.20},
...
--[[BuyVehicle = {
	...
	Job1 = {
		Pos   = {x = 1107.67, y = 3591.61, z = 32.80},
	...
	Job1a = {
		Pos   = {x = 1116.37, y = 3590.09, z = 33.00},
		Size  = {x = 2.0, y = 2.0, z = 2.0},
		Color = {r=255, g=159, b=0},
		Type  = 32, Rotate = true
	},
	...
	Job1b = {
		Pos   = {x = 1103.117, y = 3588.806, z = 32.860},
		Size  = {x = 2.0, y = 2.0, z = 2.0},
		Color = {r=255, g=159, b=0},
		Type  = 32, Rotate = true
	},
	...
	Job2 = {
		Pos   = {x = 1033.60, y = 3571.66, z = 33.10},
	...
	Job2VehicleCheck = {
		Pos   = {x = 1021.58, y = 3572.62, z = 34.03},
		Size  = {x = 2.0, y = 2.0, z = 2.0},
		Color = {r=255, g=159, b=0},
	...
	Job3 = {
		Pos   = {x = 2349.13, y = 3030.97, z = 47.35},
		Size  = {x = 3.0, y = 3.0, z = 3.0},
		Color = {r=255, g=159, b=0},
		Type  = 27, Rotate = false
	},
	...
	Job3VehicleCheck = {
		Pos   = {x = 2354.39, y = 3037.32, z = 47.55},
		Size  = {x = 2.00, y = 2.0, z = 2.0},
		Color = {r=255, g=159, b=0},
		Type  = 36, Rotate = false
	},

	Job4 = {
		Pos   = {x = 2341.27, y = 3128.42, z = 48.21},
		Size  = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r=0, g=250, b=0},
		Type  = 29, Rotate = false
	}
...
Config.Blips = {
	CloakroomScrap = {Sprite = 527},
	Zbieranie = {Sprite = 527},
	Prasa = {Sprite = 527},
	Zwrot = {Sprite = 527},
}
