...
Citizen.CreateThread(function ()
    while true do
        ...
        if PlayerData.job.name == "policejednakniebokurwalspdplacze" and firstSpawn then
          firstSpawn = false
          TriggerServerEvent('duty:spawnDuty')
        elseif PlayerData.job.name == "ambulance" and firstSpawn then
          firstSpawn = false
          TriggerServerEvent('duty:spawnDuty')
        elseif PlayerData.job.name == "mechanic" and firstSpawn then
          firstSpawn = false
          TriggerServerEvent('duty:spawnDuty')
        elseif PlayerData.job.name ~= nil then
          firstSpawn = false
        end
        if CurrentAction ~= nil and firstSpawn == false then
