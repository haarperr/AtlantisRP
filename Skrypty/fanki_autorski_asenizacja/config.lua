...
Config.Zones = {
	...
	VehicleDeleter = {
		Pos   = {x = -488.44, y = -59.36, z = 38.99},
		Size  = {x = 4.8, y = 4.8, z = 1.25},
		Color = {r = 255, g = 0, b = 0},
		Type  = 1, Rotate = false
	},

	CesspoolActions = {
		Pos   = {x = -449.73, y = -51.75, z = 43.62},
		Size  = {x = 1.4, y = 1.4, z = 2.0},
		Color = {r = 1, g = 204, b = 0},
		Type  = 27, Rotate = true
	},
	...
	--Job2 = {
	--	Pos   = {x = -106.46, y = -1063.05, z = 26.35},
	...
	--
	--Job3 = {
	--	Pos   = {x = 2339.54, y = 3047.98, z = 47.35},
