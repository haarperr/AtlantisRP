Locales['pl'] = {
  ...
  ['only_curier'] = 'możesz przechowywać tylko autoryzowane auta.',
  ['only_curier_box'] = 'aby wziąć paczki, musisz podjechać autoryzowanym pojazdem',
  ...
  ['press_to_takebox'] = 'naciśnij ~INPUT_CONTEXT~ aby wejść wziąć paczkę',
  ...
  ['must_in_curier'] = 'musisz być w taksówce aby rozpocząć misję',
  ['must_in_vehicle'] = 'musisz być w autoryzowanym pojeździe, aby rozpocząć misję',
  ['have_earned'] = 'zarabiasz ~g~$%s~s~',
  ['comp_earned'] = '- Twoja firma zarobiła ~g~$%s~s~\n- Zarabiasz ~g~$%s~s~',
  ['too_much_boxes'] = 'Już masz wystarczającą liczbę paczek',
